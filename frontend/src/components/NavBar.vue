<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../../public/taco.png" alt="" style="width: 35; height: 34px; align-self: center; padding-bottom: 8px;"/>EBEN
        </router-link>

        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">beranda</router-link>
            <router-link @click="scrollToTop()" to="/about">tentang</router-link>
            <router-link @click="scrollToTop()" to="/promotions">promosi</router-link>
            <router-link @click="scrollToTop()" to="/menu">menu</router-link>
            <router-link @click="scrollToTop()" to="/table">booking</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div v-if="!user" class="fas fa-user account" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/login">masuk</router-link>
                    </li>
                    <li>
                        <router-link @click="scrollToTop()" to="/register">daftar</router-link>
                    </li>
                </ul>
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/myorder">pesanan ku</router-link>
                    </li>
                    <li>
                        <router-link @click="handleLogout" to="/">keluar</router-link>
                    </li>
                </ul>
            </div>

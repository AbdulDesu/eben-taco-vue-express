            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="in-cart col-md-9">
                        <div class="box">
                            <div class="box-title item-total row">
                                <h3>
                                    <p style="font-size: 15px;">{{ filterFoods.length.toString() }}
                                        <span v-if="filterFoods.length < 2">hidangan</span>
                                        <span v-else>hidangan</span>
                                    </p>di keranjang anda
                                </h3>
                            </div>
                            ...
                            <div v-if="!filterFoods.length">
                                <div class="box-content row no-food">
                                    <div class="content">
                                        <h2 style="color: #057835fa;">Kamu belum memesan, ayo pilih hidangan terbaik kami!</h2>
                                    </div>
                                    <div class="image">
                                ...
                                <div v-for="(f, index) in filterFoods" :key="index">
                                    <div class="box-content row">
                                        ...
                                        <div class="item-qty col-sm-2 d-inline">
                                            <label for="iQuantity"
                                                style="font-size: 12px; padding-right: 2px;">Jumlah:</label>
                        ...
                        <div class="box-content row">
                            <router-link to="/menu" class="btn shop-btn"><i class="fa fa-arrow-left"></i>Kembali ke Menu Hidangan</router-link>
                            <button class="btn check-out-btn" style="margin-left: 10px;"
                                :disabled="filterFoods.length ? false : true" @click="checkOutBtn()"><i
                                    class="fa fa fa-shopping-cart"></i>Bayar</button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +62 85156069757</h3>
                                <span class="small">
                                    Silahkan hubungi kami jika memiliki pertanyaan.
                                </span>
                            </div>
                        </div>
                    </div>

        ...
        <div class="login-form-container">
            <form id="loginForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <input type="email" id="uEmail" name="uEmail" class="form-control" placeholder="Ketik alamat email anda..."
                        v-model="loginObj.email" />
                </div>

                <div class="form-group">
                    <input type="password" id="uPass" name="uPass" class="form-control"
                        placeholder="Ketik password anda..." v-model="loginObj.pass" />
                </div>

                <div class="form-group">
                    <input type="submit" value="Masuk" class="btn">
                    <p>Tidak memiliki akun? <router-link @click="scrollToTop()" to="/register">Daftar sekarang
                        </router-link>
                    </p>
                </div>
            </form>

...
<template>
    <div class="thank-container">
        ...
        <div class="thank-letter">
            <p v-none>Terima kasih telah mempercayai Kami</p>
            <p v-none>
                Pesanan telah dikonfirmasi dan saat ini sedang dalam antrian tim kami, EBEN Taco's Selalu berkomitmen menghadirkan layanan terbaik bagi pelanggan!
            </p>
            <router-link class="btn" to="/menu">Pesan Menu Lainnya</router-link>
        </div>
    </div>
</template>

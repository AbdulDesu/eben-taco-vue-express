    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Menyajikan rasa original mexico😋</h3>
                <p>EBEN menghadirkan makanan segar dengan kualitas terbaik.</p>
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <h3 class="title">Apa yang membuat makanan kita lezat!</h3>
                <p>Makanan kepada pelanggan selalu terjamin kualitasnya yang terbaik. Hidangan kami dibuat oleh koki Abdul (koki bintang 5 Bandung), yang menjanjikan cita rasa yang eksplosif, lembut, dan mengesankan.</p>
                <router-link @click="scrollToTop()" to="/about" class="btn">Selengkapnya</router-link>

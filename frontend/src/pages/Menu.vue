<template>
    <div class="menu-section">
        <div class="heading">
            <span>menu</span>
            <h3>Hidangan Andalan Kami</h3>
        </div>

        <div class="row">
            <div class="col-sm-4 col-12 filter-box">
                <div class="row search-box">
                    <input type="text" class="search-input" v-model="foodObj.name" placeholder="Ketik disini makan apa hari ini..." style="padding-left: 20px; padding-right: 20px;"/>
                </div>
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            ...
                            <label for="bsStatus" class="d-flex justify-content-between">Menu Favorit
                        ...
                        <li>
                            <input type="button" name="cbStatus" id="ooStatus" value="Online Only" hidden
                                @click="filterStatusBtn($event)" />
                            <label for="ooStatus" class="d-flex justify-content-between">Pesan Antar <button
                        ...
                        <li>
                            <input type="button" name="cbStatus" id="soStatus" value="Sale Off" hidden
                                @click="filterStatusBtn($event)" />
                            <label for="soStatus" class="d-flex justify-content-between">Diskon<button
                                    class="unselect-btn" @click="unselectStatusBtn($event)"
                        ...
                        <li>
                            <input type="button" name="cbStatus" id="sdStatus" value="Seasonal Dishes" hidden
                                @click="filterStatusBtn($event)" />
                            <label for="sdStatus" class="d-flex justify-content-between">Hidangan Musiman<button
                                    class="unselect-btn" @click="unselectStatusBtn($event)"
                        ...
                        <li>
                            <input type="button" name="cbStatus" id="ndStatus" value="New Dishes" hidden
                                @click="filterStatusBtn($event)" />
                            <label for="ndStatus" class="d-flex justify-content-between">Hidangan Terbaru<button
                                    class="unselect-btn" @click="unselectStatusBtn($event)"
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            ...
                            <label for="rtfPrice" class="d-flex justify-content-between">Rp 20.000 - Rp 50.000 <button
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="5,10" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rftPrice" class="d-flex justify-content-between">Rp 50.000 - 100.000<button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="10,12" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between">Rp 100.000 - Rp 120.000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            ...
                            <label for="mType" class="d-flex justify-content-between">Daging<button class="unselect-btn"
                        ...
                        <li>
                            <input type="button" name="rType" id="vType" value="vegan" hidden
                                @click="filterTypeBtn($event)" />
                            <label for="vType" class="d-flex justify-content-between">Sayuran (Vegan)<button class="unselect-btn"
                                    @click="unselectTypeBtn($event)">X</button></label>
                        </li>
            ...
            <div class="col-sm-8">
                ...
                <div class="row box-container">
                    <div v-for="(f, index) in currentPageItems" :key="index">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <button class="btn" @click="addItem(index)">+ Keranjang</button>
                            </div>
                        </div>
                    </div>
                    <div v-if="!filterFoods.length">
                        <div class="box">
                            <div class="content">
                                <h1 style="color: #057835fa;">Hasil tidak ditemukan!</h1>
                            </div>
                            <div class="image">
